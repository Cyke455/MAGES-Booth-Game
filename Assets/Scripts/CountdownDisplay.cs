...
public class CountdownDisplay : MonoBehaviour
{
    ...
    public void DisplayNumber(int number)
    {
        ...
        transform.localScale = defaultSize * 0.5f;
    }
    ...
    void Update()
    {
        ...
        transform.localScale = Vector3.Lerp(transform.localScale, defaultSize, movementAlpha);
        ...
        run.localScale = Vector3.Lerp(run.localScale, runSize, runMovementAlpha);
